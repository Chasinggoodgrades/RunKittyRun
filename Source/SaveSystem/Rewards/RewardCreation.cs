...
public static class RewardCreation
{
    ...
    {
        // Hats
        AddReward(Awards.Bandana, Constants.ABILITY_HAT_BANDANA, "head", "war3mapImported\\Bandana2.MDX", RewardType.Hat, StatTypes.Saves, 200); // 200
        AddReward(Awards.Chef_Hat, Constants.ABILITY_HAT_CHEF, "head", "war3mapImported\\ChefsHat.mdx", RewardType.Hat, StatTypes.Saves, 250); // 250
        AddReward(Awards.Santa_Hat, Constants.ABILITY_HAT_SANTA, "head", "war3mapImported\\SantaHat.mdx", RewardType.Hat, StatTypes.Saves, 300); // 300
