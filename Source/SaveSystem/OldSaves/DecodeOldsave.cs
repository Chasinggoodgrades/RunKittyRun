...
public static class DecodeOldsave
{
    public static List<KeyValuePair<object, int>> decodeValues = new List<KeyValuePair<object, int>>
    {
        ...
        new KeyValuePair<object, int>("RFiveNormal", 420),
        new KeyValuePair<object, int>("RFourNormal", 300),
        new KeyValuePair<object, int>("RThreeNormal", 300),
        new KeyValuePair<object, int>("RTwoNormal", 300),
        new KeyValuePair<object, int>("ROneNormal", 300),
