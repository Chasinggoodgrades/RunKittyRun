...
public static class PersonalBestAwarder
{
    ...
    public static void BeatRecordTime(player player)
    {
        ...
        Utility.TimedTextToAllPlayers(MessageTime, $"{Colors.PlayerNameColored(player)} has set a new personal best time of {Colors.COLOR_YELLOW}{timeFormatted}{Colors.COLOR_RESET} for {Difficulty.DifficultyOption.ToString()}|r");
    }
