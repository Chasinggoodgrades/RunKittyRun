...
public static class DecodeOldsave
{
    ...
    public static List<KeyValuePair<string, int>> decodeValues = new List<KeyValuePair<string, int>>
    {
        ...
        new KeyValuePair<string, int>(nameof(awards.Deathless5Normal), 1),  
        new KeyValuePair<string, int>(nameof(awards.Deathless4Normal), 1),  
        new KeyValuePair<string, int>(nameof(awards.Deathless3Normal), 1),  
        new KeyValuePair<string, int>(nameof(awards.Deathless2Normal), 1),  
        new KeyValuePair<string, int>(nameof(awards.Deathless1Normal), 1),  
