...
public static class DecodeOldsave
{
    ...
    public static List<KeyValuePair<string, int>> decodeValues = new List<KeyValuePair<string, int>>
    {
        ...
        new KeyValuePair<string, int>(nameof(awards.NormalDeathless5), 1),  
        new KeyValuePair<string, int>(nameof(awards.NormalDeathless4), 1),  
        new KeyValuePair<string, int>(nameof(awards.NormalDeathless3), 1),  
        new KeyValuePair<string, int>(nameof(awards.NormalDeathless2), 1),  
        new KeyValuePair<string, int>(nameof(awards.NormalDeathless1), 1),  
