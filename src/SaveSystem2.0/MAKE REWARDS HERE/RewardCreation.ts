...
class RewardCreation
{
    ...
    public static AddReward: Reward(name: string, abilityID: number, originPoint: string, modelPath: string, rewardType: RewardType)
    {
    ...
    /// <param name="rewardType">The type of the reward (e.g., skin, ability, item).</param>
    /// <returns>Returns an instance of the created reward.</returns>
    public static AddReward: Reward(name: string, abilityID: number, skinID: number, rewardType: RewardType)
    {
    ...
    /// <returns>Returns an instance of the created reward.</returns>
    public static AddReward: Reward(name: string, abilityID: number, skinID: number, rewardType: RewardType, gameStat: string, gameStatValue: number)
    {
    ...
    /// <param name="gameStatValue">The value of the game statistic associated with the reward.</param>
    /// <returns>Returns an instance of the created reward.</returns>
    public static AddReward: Reward(name: string, abilityID: number, originPoint: string, modelPath: string, rewardType: RewardType, gameStat: string, gameStatValue: number)
    {
    ...
    public static SetupRewards()
    {
        ...
        AddReward(nameof(awardsSorted.Wings.CosmicWings), Constants.ABILITY_WINGS_COSMIC, "chest", "war3mapImported\\Wings: Void.mdx", RewardType.Wings, nameof(stats.Saves), 550);
        AddReward(nameof(awardsSorted.Wings.VoidWings), Constants.ABILITY_WINGS_VOID, "chest", "war3mapImported\\Wings: Cosmic.mdx", RewardType.Wings, nameof(stats.Saves), 500);
        ...
        AddReward(nameof(awardsSorted.Wings.NatureWings), Constants.ABILITY_WINGS_NATURE, "chest", "war3mapImported\\Wings2: Nature.mdx", RewardType.Wings, nameof(stats.Saves), 750);
        ...
        // WindWalks
        AddReward(nameof(awardsSorted.Windwalks.WWBlood), Constants.ABILITY_WW_BLOOD, "chest", "war3mapImported\\Blood: Windwalk.mdx", RewardType.Windwalks);
        AddReward(nameof(awardsSorted.Windwalks.WWBlue), Constants.ABILITY_WW_BLUE, "chest", "war3mapImported\\Blue: Soul: Windwalk", RewardType.Windwalks);
        AddReward(nameof(awardsSorted.Windwalks.WWFire), Constants.ABILITY_WW_FIRE, "chest", "war3mapImported\\Fire: Windwalk.mdx", RewardType.Windwalks);
        AddReward(nameof(awardsSorted.Windwalks.WWNecro), Constants.ABILITY_WW_NECRO, "chest", "war3mapImported\\Necro: Soul: Windwalk.mdx", RewardType.Windwalks);
        ...
        AddReward(nameof(awardsSorted.Windwalks.WWViolet), Constants.ABILITY_WW_VIOLET, "chest", "war3mapImported\\Violet: Windwalk.mdx", RewardType.Windwalks);
        // Deathless
        ...
        // Team Deathless
        AddReward(nameof(awardsSorted.Deathless.NormalTeamDeathless), Constants.ABILITY_NORMAL_TEAM_DEATHLESS, "origin", "war3mapImported\\NormalTeamDeathless.mdx", RewardType.Deathless);
        AddReward(nameof(awardsSorted.Deathless.HardTeamDeathless), Constants.ABILITY_HARD_TEAM_DEATHLESS, "origin", "war3mapImported\\HardTeamDeathless.mdx", RewardType.Deathless);
        AddReward(nameof(awardsSorted.Deathless.ImpossibleTeamDeathless), Constants.ABILITY_IMPOSSIBLE_TEAM_DEATHLESS, "origin", "war3mapImported\\ImpossibleTeamDeathless.mdx", RewardType.Deathless);
