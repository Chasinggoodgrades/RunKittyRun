...
class KittyTime
{
    ...
    private Dictionary<int, float> RoundTime = new Dictionary<int, float>();
    private Dictionary<int, float> RoundProgress = new Dictionary<int, float>();
    ...
    private SetTotalTime() // Solo Tournament Issue
    {
        TotalTime = 0.0;
    ...
    public GetOverallProgress(): number // Solo Tournament Issue
    {
