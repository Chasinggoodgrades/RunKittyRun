...
import { Trigger, Rectangle, MapPlayer, Region, Unit } from "w3ts"
...
export class Safezone {
    ...
    private EnterSafezoneActions() {
        try {
            ...
            if (GetUnitTypeId(unit.handle) == Constants.UNIT_SHADOWKITTY_RELIC_SUMMON) {
    ...
    public static WolfEntersSafezoneActions(unit: Unit) {
        if (GetUnitTypeId(unit.handle) != Wolf.WOLF_MODEL) return false
