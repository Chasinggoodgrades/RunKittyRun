...
export class ProtectionOfAncients {
    ...
    public static SetProtectionOfAncientsLevel(unit: Unit) {
        ...
        if (abilityLevel > 0) {
            ...
            if (abilityLevel == 2) {
                ...
                ProtectionOfAncients.UpgradeLevel2.Remove(player) // Ensure the player is only in one list
            }
        }
        return abilityLevel
    }
    ...
    private static RegisterUpgradeLevelEvents() {
        ...
        LevelUpTrigger.registerAnyUnitEvent(playerunitevent.getHeroLevel())
    ...
    private static RegisterEvents() {
        ...
        Trigger.registerAnyUnitEvent(EVENT_PLAYER_UNIT_SPELL_CAST)
        ...
        Trigger.addAction(ProtectionOfAncients.ActivationEvent)
