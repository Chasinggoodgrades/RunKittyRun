...
class CameraUtil
{
    private static List<player> LockedCameras = new List<player>();
    private static List<player> KomotoCamEnabled = new List<player>();
    ...
    public static HandleZoomCommand(p: player, string[] args)
    {
        if (args[0] == "") return;
