...
class Utility
{
    ...
    public static CreateSimpleTextTag(text: string, duration: number, u: unit, height: number = 0.015, red: number = 255, green: number = 255, blue: number = 255)
    {
    ...
    public static GetPlayerByName: player(playerName: string)
    {
    ...
    public static CreateFilterFunc: filterfunc(Func<bool> func)
    {
