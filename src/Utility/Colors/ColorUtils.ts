...
export class ColorUtils {
    ...
    public static Initialize = () => {
        ...
        ColorUtils.AddColor('brown', 12, '|cff4f2b05', PLAYER_COLOR_BROWN, 79, 43, 5)
        ...
        ColorUtils.AddColor('violet', 16, '|cffbd00ff', PLAYER_COLOR_VIOLET, 189, 0, 255)
        ...
        ColorUtils.AddColor('coal', 21, '|cff4f5055', PLAYER_COLOR_COAL, 79, 80, 85)
        ColorUtils.AddColor('snow,white', 22, '|cffecf0ff', PLAYER_COLOR_SNOW, 236, 240, 255)
        ColorUtils.AddColor('emerald', 23, '|cff00781e', PLAYER_COLOR_EMERALD, 0, 120, 30)
        ColorUtils.AddColor('peanut', 24, '|cffa56f34', PLAYER_COLOR_PEANUT, 165, 111, 52)
    }
