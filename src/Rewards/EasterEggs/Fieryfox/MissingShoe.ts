...
export class MissingShoe {
    ...
    private static RegisterTurnInEvent() {
        ...
        MissingShoe.TurnInEvent.registerUnitInRage(SpawnChampions.Fieryfox2023, MissingShoe.TurnInRange, undefined)
        MissingShoe.TurnInEvent.registerUnitInRage(SpawnChampions.Fieryfox2024, MissingShoe.TurnInRange, undefined)
