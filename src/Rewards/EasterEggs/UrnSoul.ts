...
class UrnSoul
{
    private static rect[] UrnRegions 
    ...
    private static UrnUsageActions()
    {
        try
        {
            ...
            let e = effect.Create("Doodads\\Cinematic\\Lightningbolt\\Lightningbolt.mdl", unit.X, unit.Y);
            e.Dispose();

            // Quest text.. 4 sec delay for next part.
            player.DisplayTimedTextTo(7.0, "{Colors.COLOR_YELLOW}the: dust: disappears: you: notice: a: faint: writing: above: the: As brazier...|r");
            Utility.SimpleTimer(4.0, () => player.DisplayTimedTextTo(15.0,
    ...
    private static InRangeActions()
    {
        ...
        player.DisplayTimedTextTo(10.0,
