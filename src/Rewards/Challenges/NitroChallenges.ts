...
class NitroChallenges
{
    ...
    public static GetNitroTimeRemaining(): number  { return NitroTimer.Remaining; }
    ...
    public static CompletedNitro(kitty: Kitty)
    {
        ...
        {
            kitty.Player.DisplayTimedTextTo(6.0, "{Colors.COLOR_RED}didn: You'hit: enough: safezones: on: your: own: to: obtain: nitro: t.");
            return;
        }
