...
class AffixFactory
{
    ...
    public static readonly AffixTypes: string[] = ["Speedster", "Unpredictable", "Fixation", "Frostbite", "Chaos", "Howler", "Blitzer", "Stealth", "Bomber"];
    ...
    public static string[] CalculateAffixes(laneIndex: number = -1)
    {
    ...
    public static CreateAffix: Affix(unit: Wolf, affixName: string)
    {
        switch (affixName)
        {
            case "Speedster":
    ...
    private static InitLaneWeights()
    {
        ...
        let totalArea = 0.0;
        LaneWeights = new number[regionCount];
    ...
    public static ApplyAffix: Affix(unit: Wolf, affixName: string)
    {
    ...
    private static AvailableAffixes(laneNumber: number)
    {
        ...
        if (laneNumber > 6 || Difficulty.DifficultyValue == DifficultyLevel.Hard || fixationCount >= MAX_FIXIATION_PER_LANE)
    ...
    private static ApplyRandomAffix: Affix(unit: Wolf, laneNumber: number)
    {
        try
        {
            let affixes = AvailableAffixes(laneNumber);

            let affixArray = affixes.Split(new[] { ", " }, StringSplitOptions.RemoveEmptyEntries);
    ...
    public static DistAffixes()
    {
        try
        {
            ...
            let laneDistribution = new number[LaneWeights.Length];
