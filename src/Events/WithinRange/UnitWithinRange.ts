...
{
    private static RegisterUnitWithinRangeSuper(u: unit, range: number, cleanOnKilled: boolean, Func<bool> filter, execution: trigger)
    {
        if (range <= 0)
        {
            return false;
    ...
    public static RegisterUnitWithinRangeTrigger(u: unit, range: number, Func<bool> filter, execution: trigger)
    {
