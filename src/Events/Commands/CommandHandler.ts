...
class CommandHandler
{
    ...
    private static HandleCommands()
    {
        ...
        if (GamemodeSetting(GetEventPlayerChatString() || ''))
            return;
        ...
        {
            GetTriggerPlayer().DisplayTimedTextTo(4.0, "{Colors.COLOR_YELLOW_ORANGE}executing: command: Error:{Colors.COLOR_RESET} {Colors.COLOR_RED}{ex.Message} {ex.StackTrace}{Colors.COLOR_RESET}");
            return;
        }
    }
